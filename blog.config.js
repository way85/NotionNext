...
const BLOG = {
  AUTHOR: 'Eric', // 作者
  BIO: '希望过上猪一样的生活，也能像猪一样快乐🍚', // 作者简介
  LINK: 'https://way85.com', // 网站地址
  KEYWORDS: 'Blockchain, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || '', // 你的Github仓库名 e.g 'way85/NotionNext'
